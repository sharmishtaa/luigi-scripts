...
class register(luigi.Task):
	...
	#		os.mkdir ("../processed/registration_tilespec/")
		...
		outputtilespec = "../processed/registration_tilespec/DAPI_%01d_rib%04dsess%04dsect%04d.json"%(self.session,self.ribbon, self.session, self.section)				
	...
	def requires(self):
		...
		inputtransformspec = "../processed/stitched_transformspec/rib%04dsess%04dsect%04d.json"%(self.ribbon, self.session, self.section)	
		...
		referencetransformspec = "../processed/stitched_transformspec/rib%04dsess%04dsect%04d.json"%(self.ribbon, self.refsession, self.section)
		outputtilespec = "../processed/registration_tilespec/DAPI_%01d_rib%04dsess%04dsect%04d.json"%(self.session,self.ribbon, self.session, self.section)
		...
		self.cmd = "java -cp /home/sharmishtaas/allen_SB_code/render/render-app/target/render-app-0.3.0-SNAPSHOT-jar-with-dependencies.jar:/home/sharmishtaas/.m2/repository/sc/fiji/Fiji_Plugins/2.0.1/Fiji_Plugins-2.0.1.jar org.janelia.alignment.RegisterSections --modelType 1 --percentSaturated 0.9f --maxEpsilon 2.5 --initialSigma 2.5 --inputtilespec "
